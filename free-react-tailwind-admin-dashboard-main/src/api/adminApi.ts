...
export async function getListDepartmentApi() {
  const res = await axiosInstance.get(`${API_BACKEND_URL}/departments/active`);
  return res;
}
...
export async function postListDepartmentApi(data: CreateDepartmentRequest) {
  const res = await axiosInstance.post(`${API_BACKEND_URL}/departments`, data);
  return res;
}
...
export async function postDepartmentApi(data: CreateDepartmentRequest) {
  const res = await axiosInstance.post(`${API_BACKEND_URL2}/departments`, data);
  return res;
}
...
export async function createCategoryApi(data: any) {
  const res = await axiosInstance.post(`${API_BACKEND_URL2}/categories`, data);
  return res;
}
