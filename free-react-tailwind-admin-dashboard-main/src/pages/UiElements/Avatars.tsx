...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | Quản lý tài sản - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for Quản lý tài sản - React.js Tailwind CSS Admin Dashboard Template"
      />
