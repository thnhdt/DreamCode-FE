...
export default function Badges() {
  return (
    <div>
      <PageMeta
        title="React.js Badges Dashboard | Quản lý tài sản - React.js Admin Dashboard Template"
        description="This is React.js Badges Dashboard page for Quản lý tài sản - React.js Tailwind CSS Admin Dashboard Template"
      />
